...
namespace LevelEditor
{
    public partial class TestPositionForm : Form
    {
        ...
        private ParticleEmitterComponent mParticleTest;
        ...
        public TestPositionForm()
        {
            ...
            //mParticleTest = new ParticleEmitterComponent(mComponents);
            ...
            //Controls.Add(mParticleTest.GetGroupbox());
            AutoSize = false;
        ...
        public void SetObject(List<Component> _list)
        {
            Controls.Clear();
            mComponents = _list;
            if(_list != null)
            {
                ...
                {
                    Controls.Add(_list[i].GetGroupbox());
                }
        ...
        public void Refresh()
        {
            ...
            {
                Controls.Add(mComponents[i].GetGroupbox());
            }
            ReorderComponents(null, null);
        }
