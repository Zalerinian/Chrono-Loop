...
namespace LevelEditor
{
    public abstract class Component
    {
        ...
        public virtual void WriteComponentData(XmlWriter _w)
        {
            System.Diagnostics.Debug.Print("Someone tried to write a component that wasn't overridden to write data!");
        }

        // Todo make this abstract later
        public virtual void ReadComponentData(XmlReader _r)
        {
            System.Diagnostics.Debug.Print("Someone tried to write a component that wasn't overridden to read data!");
        }
    }
}