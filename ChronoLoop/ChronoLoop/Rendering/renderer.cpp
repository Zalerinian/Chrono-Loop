...
Renderer::RendererInstance* Renderer::sInstance = nullptr;

Renderer::RendererInstance::RendererInstance() {}
...
void Renderer::RendererInstance::Render() {
...
Renderer::RendererInstance * Renderer::Instance() {
	return sInstance;
}
...
bool Renderer::Initialize(HWND _Window, unsigned int _width, unsigned int _height, bool _vsync, int _fps, bool _fullscreen, float _farPlane, float _nearPlane, vr::IVRSystem * _vrsys) {
	...
	sInstance = new Renderer::RendererInstance();
