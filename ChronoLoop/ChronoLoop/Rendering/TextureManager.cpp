...
namespace Epoch {
	...
	TextureManager::~TextureManager() {
		// Don't need to delete anything because ComPtr's :D
	}
	...
	TextureManager::TextureStatus TextureManager::iAddTexture2D(std::string& _name, ID3D11Texture2D * _tex, Microsoft::WRL::ComPtr<ID3D11ShaderResourceView>* _srv) {
		if (_tex == nullptr) {
