...
namespace Epoch {
	...
	struct Level3TeleportAction : public CodeComponent {
		...
		MeshComponent *mUpperPlaneMesh, *mGlassPlaneMesh, *mLowerPlaneMesh, *mBox1Mesh, *mBox2Mesh, *mBox3Mesh, *mPillar1Mesh, *mPillar2Mesh, *mPillar3Mesh, *mPillar4Mesh, *mElevatorMesh, *mUpperWallMesh, *mLowerWallMesh;
		BaseObject*mUpperPlaneObject, *mGlassPlaneObject, *mLowerPlaneObject, *mBox1Object, *mBox2Object, *mBox3Object, *mPillar1Object, *mPillar2Object, *mPillar3Object, *mPillar4Object, *mHeadset, *mElevatorObject, *mUpperWallObject, *mLowerWallObject;
			...
			if (!interp->GetActive()) {
				if (VRInputManager::GetInstance().GetController(mControllerRole).GetPressDown(vr::EVRButtonId::k_EButton_SteamVR_Touchpad) && !Settings::GetInstance().GetBool("PauseMenuUp")) {
					if (!paused) {
						...
						MeshComponent* meshes[] = { mBox1Mesh, mBox2Mesh, mBox3Mesh, mPillar1Mesh, mPillar2Mesh, mPillar3Mesh, mPillar4Mesh, mUpperWallMesh, mLowerWallMesh };
						BaseObject* objects[] = { mBox1Object, mBox2Object, mBox3Object, mPillar1Object, mPillar2Object, mPillar3Object, mPillar4Object, mUpperWallObject, mLowerWallObject };
						...
						MeshComponent* TeleMeshes[] = { mUpperPlaneMesh, mGlassPlaneMesh, mLowerPlaneMesh, mElevatorMesh };
						BaseObject* TeleObjects[] = { mUpperPlaneObject, mGlassPlaneObject, mLowerPlaneObject, mElevatorObject };
