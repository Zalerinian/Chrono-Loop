		...
		virtual void Update()
		{
			if (!once)
			{
				...
				if (/*status == LM::LevelStatus::Success*/ true)
				{
					...
					ParticleEmitter* startEmit = new TeleportEffect(400, 250, 2, vec4f(-15.78, 0, -2.86f, 1));
					...
					ParticleEmitter* startEmit2 = new TeleportEffect(400, 150, 1, vec4f(-15.78, 0, -2.86f, 1));
